...
- Add a `workflows` module that renders, writes, and checks managed workflows from validated configuration.
...
- Strengthen CI/release workflows and bump the compatibility-changing unreleased package to `0.2.0`.
...
- Publishing `0.2.0` to PyPI or pushing the branch.
